...
export function getToken() { return localStorage.getItem('yc_token') || '' }
export function setToken(token: string) { localStorage.setItem('yc_token', token) }
export function clearToken() { localStorage.removeItem('yc_token') }
